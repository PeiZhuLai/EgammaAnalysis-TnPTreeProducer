...
if varOptions.GT == "auto":
  if options['isMC']:
    ...
    if options['era'] == '2022preEE': options['GLOBALTAG']  = '130X_mcRun3_2022_realistic_v5'
...
if not options['useAOD']:
  ...
  process.init_sequence += leptonMvaSequence(process, options, tnpVars)
    # 添加隔离计算模块,画蛇添足
  # from PhysicsTools.NanoAOD.electronIsolation_cff import isoForEle
  # from EgammaAnalysis.TnPTreeProducer.electronIsolation_cff import isoForEle
  # process.isoForEle = isoForEle.clone(
  #   src = cms.InputTag(options['ELECTRON_COLL']),
  #   rho_MiniIso = cms.InputTag("fixedGridRhoFastjetAll"),
  #   rho_PFIso = cms.InputTag("fixedGridRhoFastjetAll"),
  #   EAFile_MiniIso = cms.FileInPath("/eos/home-h/haozhong/diele_HLT_sf/CMSSW_13_1_0/src/EgammaAnalysis/effAreaElectrons_cone03_pfNeuHadronsAndPhotons_122X.txt"),
  #   EAFile_PFIso = cms.FileInPath("/eos/home-h/haozhong/diele_HLT_sf/CMSSW_13_1_0/src/EgammaAnalysis/effAreaElectrons_cone03_pfNeuHadronsAndPhotons_122X.txt"),
